...
type SimpleRequest struct {
	...
	// 定义发送的参数
	// 参数类型 参数名 标识号(不可重复)
	Data string `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"` // 1是标识符 代表的是 参数所处的位置
}
...
var file_simple_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x22, 0x4e, 0x0a, 0x0e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x73,
	...
	0x61, 0x6d, 0x65, 0x32, 0x37, 0x0a, 0x09, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x53, 0x61, 0x79,
	0x12, 0x2a, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x0e, 0x2e, 0x53, 0x69, 0x6d, 0x70,
	0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x53, 0x69, 0x6d, 0x70,
...
var file_simple_proto_depIdxs = []int32{
	0, // 0: SimpleSay.Route:input_type -> SimpleRequest
	1, // 1: SimpleSay.Route:output_type -> SimpleResponse
