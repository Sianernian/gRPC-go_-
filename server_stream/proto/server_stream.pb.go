...
func (x *ServerStreamRequest) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *ServerStreamResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *PingResponse) Reset() {
	*x = PingResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_server_stream_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return file_server_stream_proto_rawDescGZIP(), []int{3}
}
...
var file_server_stream_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x29, 0x0a, 0x13, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x09, 0x6c, 0x69, 0x73, 0x74, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x12, 0x14, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x30, 0x01, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_server_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_server_stream_proto_goTypes = []interface{}{
	(*ServerStreamRequest)(nil),  // 0: ServerStreamRequest
	(*ServerStreamResponse)(nil), // 1: ServerStreamResponse
	(*PingRequest)(nil),          // 2: PingRequest
	(*PingResponse)(nil),         // 3: PingResponse
}
var file_server_stream_proto_depIdxs = []int32{
	2, // 0: ServerStreamTalk.Ping:input_type -> PingRequest
	0, // 1: ServerStreamTalk.listValue:input_type -> ServerStreamRequest
	3, // 2: ServerStreamTalk.Ping:output_type -> PingResponse
	1, // 3: ServerStreamTalk.listValue:output_type -> ServerStreamResponse
...
func file_server_stream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_server_stream_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
